...
*/
public class EstateFactory extends Factory
{
  ...
  /**
  * Create the Java bean Estate for the root element
  *   @param rootElementname The tag for the root element
  *   @return Estate The Java bean representing this element
  */
  public Estate createRoot(String rootElementname)
  {
    return (Estate) createRootDOMFromComplexType("Estate",rootElementname);
  }
  
  /**
  * Create the Java bean Estate by loading the XML file
  *   @param filename The XML file name
  *   @return Estate The Java bean representing the root element
  */
  public Estate loadDocument(String filename)
  {
    return (Estate) loadDocument("Estate",filename);
  }
