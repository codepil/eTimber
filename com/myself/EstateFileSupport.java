...
*/
public class EstateFileSupport
{
  IncomingFactory iIncomingFactory;
  Incoming iIncoming;

  public EstateFileSupport()
  {
  }
  ...
  */
  Estate initEstate(Estate iEstate)
  {
    ...
    iEstate.setTcft("tcft");
    iEstate.setDiscount("discount");
    iEstate.setDisTcft("disTcft");
  ...
  */
  void printEstate(Estate iEstate)
  {
    ...
    System.out.println(iEstate.getTcft());
    System.out.println(iEstate.getDiscount());
    System.out.println(iEstate.getDisTcft());
  }
  ...
  */
  ...
  /**
  * Set the element disTcft to the specified value
  *   @param iDisTcft The Java bean for this element
  *   @return disTcft The Java bean
  */
  disTcft initdisTcft(disTcft iDisTcft)
  {
    iDisTcft.updateElementValue("disTcft");
    return iDisTcft;
  }

  /**
  * Print the element value represented by the Java bean disTcft
  *   @param iDisTcft The Java bean for this element
  */
  void printdisTcft(disTcft iDisTcft)
  {
    System.out.println(iDisTcft.getElementValue());
  }

  /**
  * Set the element discount to the specified value
  *   @param iDiscount The Java bean for this element
  *   @return discount The Java bean
  */
  discount initdiscount(discount iDiscount)
  {
    iDiscount.updateElementValue("discount");
    return iDiscount;
  }

  /**
  * Print the element value represented by the Java bean discount
  *   @param iDiscount The Java bean for this element
  */
  void printdiscount(discount iDiscount)
  {
    System.out.println(iDiscount.getElementValue());
  }
  ...
  */
  public static void main(String args[])
  {
    ...
    //sample.createNewInstance("C:/pavan/j2eeWork/ws-studio-ie-workspace/xml-test/HTMLtoXSLProject/IncomingTimber/estateSampleSample.xml");
    //sample.loadExistingInstance("C:/pavan/j2eeWork/ws-studio-ie-workspace/xml-test/HTMLtoXSLProject/IncomingTimber/estateSampleSample.xml");
  }
}
