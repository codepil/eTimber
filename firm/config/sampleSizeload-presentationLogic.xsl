    ...
    <table class="others" border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody>
        <tr>
          ...
          <td>
            <b>No:</b>&#160;&#160; <xsl:value-of select="$billNo"/>
            <br/>
            <b>Order No:</b>&#160;&#160; <xsl:value-of select="$orderNo"/>
            <br/>
            <b>Articles:</b>&#160;&#160; <xsl:value-of select="$articles"/>
            <br/>
            <b>Lorry No:</b>&#160;&#160; <xsl:value-of select="$lorryName"/>
            <br/>
